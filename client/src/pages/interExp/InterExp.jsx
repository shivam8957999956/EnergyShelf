...
export default function InterExp() {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      const res = await axiosInstance.get("/posts/?cat=interviews");
      setPosts(res.data);
    };
    fetchPosts();
    ...
    const getPost1 = async () => {
      const res1 = await axiosInstance.get("/popularity/?today=interviews");
  ...
  const handleClick = async (e) => {
    const res = await axiosInstance.get("/posts/?title=" + e);
    setPosts(res.data);
  };
