...
export default function ExploreNew() {
  ...
  useEffect(() => {
    const get = async () => {
      ...
      const res1 = await axiosInstance.get("/profile/views");
      // console.log(res1.data);
      setCont(res1.data);
      const res3 = await axiosInstance.get("/posts/?editor=true");
      // console.log(res1.data);
      setEditor(res3.data);
      const res4 = await axiosInstance.get("/event");
      // console.log(res.data);

      setEvent(res4.data);
      const res5 = await axiosInstance.get("/category");
      // console.log(res);
      setCat(res5.data);
    };
    get();
